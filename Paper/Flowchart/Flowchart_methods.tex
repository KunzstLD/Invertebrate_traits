...
\begin{tikzpicture}
      ...
      \node(omission)[intstepsnode, align = center, xshift = 5cm, yshift = 0cm]{Omitted taxa lower \\ family-level};
      ...
      \node(harmonization)[mainnode, align = center, xshift = -5cm, yshift = -2.5cm]{Harmonization};
      ...
      \node(frameHarmAggr) [frame, fit = (harmonization) (traitAgg)] {};
      ...
      \draw[->] (harmonization.east) -- (conversionPerc.west);
