\documentclass[../Main_Document-Latex.tex]{subfiles}
...
\begin{tikzpicture}
      %% Nodes
      \node(duplTaxa)[intstepsnode, align = center] at (-5cm,0cm){Consolidating duplicate \\ taxa in  EU, NA, AUS \& \\ NZ databases};
