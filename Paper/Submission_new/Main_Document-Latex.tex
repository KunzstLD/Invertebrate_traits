...
%\usepackage[a4paper, margin = 1n]{geometry}
...
% replace "and" in authoryear in-text citations with "&" 
...
% custom style for first page
\fancypagestyle{firstpage}
{
    \fancyhead[L]{Data-related issues in trait databases}    
    \fancyhead[R]{}
}
...
\begin{landscape}
  \begin{table}[H]
    ...
    \toprule[.1em]
    \multirow{4}{*}{\specialcell{AUS}} & \specialcell{\textit{direct\_agg\textsubscript{median}}} & 16.65 & 0.01 & 1.00 & 0.45 & 0.27 \\ 
    & \specialcell{\textit{direct\_agg\textsubscript{mean}}} & 23.35 & 0.01 & 0.98 & 0.33 & 0.23 \\ 
    & \specialcell{\textit{stepwise\_agg\textsubscript{median}}} & 18.01 & 0.01 & 1.00 & 0.41 & 0.26 \\ 
    & \specialcell{\textit{stepwise\_agg\textsubscript{mean}}} & 23.35 & $< 0.01$ & 0.99 & 0.33 & 0.22 \\ 
    & \specialcell{\textit{weighted\_agg}} & 23.35 & $< 0.01$ & 1.00 & 0.34 & 0.24 \\ 
    \midrule
    \multirow{4}{*}{\specialcell{NA}} & \specialcell{\textit{direct\_agg\textsubscript{median}}} & 15.58 & 0.25 & 1.00 & 0.68 & 0.27 \\ 
    & \specialcell{\textit{direct\_agg\textsubscript{mean}}} & 44.87 & $< 0.01$ & 1.00 & 0.31 & 0.26 \\ 
    & \specialcell{\textit{stepwise\_agg\textsubscript{median}}} & 18.71 & 0.12 & 1.00 & 0.60 & 0.29 \\ 
    & \specialcell{\textit{stepwise\_agg\textsubscript{mean}}} & 44.87 & $< 0.01$ & 1.00 & 0.31 & 0.27 \\ 
    & \specialcell{\textit{weighted\_agg}} & 44.87 & $< 0.01$ & 1.00 & 0.31 & 0.28 \\ 
    \bottomrule
    \end{tabular}
  \end{table}
  \begin{minipage}{\linewidth}{\fontsize{8}{10}\selectfont
