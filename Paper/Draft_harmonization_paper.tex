...
\begin{itemize}
  ...
  \begin{itemize}
    ...
    \item Taxonomic hierarchy in the investigated datasets? \\
     $\rightarrow$ In every investigated dataset, most families have only one genus  
