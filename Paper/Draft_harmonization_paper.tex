...
% Discussion/Comparison aggr. methods  
...
% Check for those cases that deviate a lot -> how have the aggregation and assignments performed when looking back at the original data?

% Also briefly talk about traits that are more consistent?
...
% Outlook: Are there alternatives to trait aggregation? Some statistical models combine trait information for priors (species distribution models/population growth models, see Kindvater et al 2018 and Brown & Roff)
