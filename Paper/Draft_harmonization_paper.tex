...
% Influence of aggregation methods on trait-environment relationships:
% 1) In general, differences produced by the aggregation methods seem to arise by using mean or median, 
...
% Simulation result: 
% -  base simulation with similar amount of speices per genus and genera per family and varying trait values
