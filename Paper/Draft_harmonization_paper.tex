...
1. In recent years, comprehensive invertebrate trait databases have been established for different continents. The wide availability of invertebrate trait data should have created an impetus for trait-based studies, especially on large scales. However, a number of data-related problems hamper the work with trait data. For example, standardised trait definitions are lacking and coding of traits varies across trait databases impeding trait data synthesis. Another issue is different taxonomic resolutions between observational taxonomic data and trait databases, leading to the need to aggregate traits. 
% The aim of our study was to investigate discrepancies in trait definitions, to evaluate different trait aggregation methods and  
