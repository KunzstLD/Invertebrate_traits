...
% PUP Comment: „Rather“ important at the „trait“ scale, but were differences so important at the „grouping feature“ scale, after transforming trait scores into a relative frequency distribution? (probably interesting to examine in order to try explaining the low impact of the selected strategy on the RDA results when revisiting the data of Szöcs et al. (2018)).
\begin{table}[H]
  \centering
