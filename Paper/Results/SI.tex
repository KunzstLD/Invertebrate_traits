...
\begin{table}[ht]
    \centering
    \caption{Mean, median and standard deviation of the traits that were responsive to the salinity gradient in the original study but not when re-analysis with the harmonized dataset trait dataset.} 
