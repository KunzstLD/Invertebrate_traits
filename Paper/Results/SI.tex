...
% %\begin{table}[ht]
% %    \centering
%     \caption{Representation of traits per grouping feature and their harmonization for the European trait databases. The color coding indicates traits that have been harmonized. Cyan colored traits have not been used because they were too different from the amalgamated traits.}
%     \endfirsthead
%     \endhead
%     %\begin{tabular}{llll}
%     \hline
%     Grouping feature & Freshwater ecology & Tachet & Amalgamated traits \\ 
%     \hline
%     \hline
